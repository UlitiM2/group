...
Проанализировав таблицу, можно сделать вывод, что для сервисов Microsoft Azure существуют аналогу в Yandex Cloud и VK Cloud, однако функционал некоторых из российских сервисов является более обобщенным. Так, некоторые сервисы из Yandex Cloud и VK Cloud могут заменять два или более сервисов Azure.
