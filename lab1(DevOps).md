...
Ключи помогают аутентифицировать безопасные соединения, с их помощью создается безопасный канал связи c удаленным компьютером, позволяя им управлять и передавать файлы. \
